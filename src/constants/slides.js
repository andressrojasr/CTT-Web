// Slides del Hero principal (Home)
export const heroSlides = [
  {
    id: 1,
    image: "https://ctt-talleresfisei.uta.edu.ec/img/carrusel/carrusel_2.jpeg",
  ...
  {
    id: 2,
    image: "https://www.lahora.com.ec/__export/1744656999548/sites/lahora/img/2025/04/14/20250414_125632861_Universidad_Txcnica_de_Ambato_define_fechas_de_inicio_de_matrxculas.jpg",
    title: "CURSOS VIRTUALES Y PRESENCIALES",
    subtitle: "Compromiso con el desarrollo tecnológico.",
    buttonText: "Conoce los cursos",
    buttonLink: "#",
...
// Slides del Banner "Sobre Nosotros"
...
// Slides del carrusel de proyectos UTA
...
// Slides de la página de cursos
export const coursesHeroSlides = [
  {
    id: 1,
    image: "https://ctt-talleresfisei.uta.edu.ec/img/carrusel/carrusel_2.jpeg",
    title: "Cursos",
